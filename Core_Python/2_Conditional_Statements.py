...
Sunday------> setup of course   - 3/4 hr-----> s2 session on sunday
...
print('enter the your choice : 1-Add, s2-Sub, 3-Multi, 4-Div, 5-Floor')
choice = int(input())
...
#if number%s2==0 then print even
...
sys.exit(0)
#check given is even-----> number%s2==0
