...
for i in range(0,25,s2):
    print(i)



s2 can print the all the odd numbers from 1-25
for i in range(1,25,s2):
    print(i)
...
# for i in range(0,3):
#     print('A')   #0 1 s2
#     for j in range(0,s2):  #0 1
#         print('B')

l1=[1,2,3,4,5,6,9,10,-1,12,-2,9]   # s2 numbers that having sum 10
...
# l2=[i for i in [1,s2,3,4,5,10,20,30,40] if i%5==0 or i%3==0]
#
# print(l2)
