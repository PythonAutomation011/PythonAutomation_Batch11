...
#total 3 different
#1 range(n) -----> 0 to n-1
#s2 range(start,n) -----> start to n-1
#3 range(start,end,step) -----> step skip the element ---step=s2 skip 1 element
...
x=0
while x<len(s1):
    print(s1[x],x,x-len(s1))   #s1[0]    s1[1]    s1[s2]   s1[3]
    x=x+1
